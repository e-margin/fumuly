...
- 振込用紙・納付書では「払込金額」「振込金額」「納付額」「お支払い金額」「合計請求額」と明記された欄の数字を使う
- 奨学金（JASSO等）の振込用紙：「払込金額」欄（元金＋利息＋延滞金＋督促手続費の合計）が amount。個別の内訳（元金、利息、延滞金、督促手続費）は amount に入れない
- 以下は amount に入れてはならない：借用金額、残元金、貸付残高、前回入金額、前回振込額、延滞据置利息残高
- 「今月の請求額」と「分割払い残高」が混在する場合、今月の支払い額を amount に入れる
- 判断に迷う場合：振込用紙の払込取扱票部分に印字されている金額を優先する
